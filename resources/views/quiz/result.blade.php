            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    <div class="mb-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
                        ...
                        <div class="space-y-9">
                            <div class="rounded-xl bg-gray-50 p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <dd class="text-lg font-semibold text-gray-900">{{ $attempt->quiz->name }}</dd>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('quiz.result', $attempt->id)) }}" target="_blank" class="pointer-events-none text-blue-600 hover:text-blue-800">
                                        ...
                                        <a href="https://api.whatsapp.com/send?text=Heyy! 👋😎 Aku abis ngerjain kuis seru nih buat tes seberapa pinter otakku! 🧠✨ Penasaran sama hasilnya? 🤔 Yuk cek di sini: {{ urlencode(route('quiz.result', $attempt->id)) }} 📊🎯 Kalian juga cobain dong, siapa tau bisa ngalahin skorku! 😏🔥"
                        ...
                        <div class="space-y-6">
                            <div class="{{ $attempt->score >= 70 ? 'from-emerald-50 to-emerald-100 border-emerald-200' : 'from-rose-50 to-rose-100 border-rose-200' }} rounded-xl border-2 bg-gradient-to-br p-6 text-center">
                                <h2 class="mb-6 text-lg font-semibold text-gray-800">Hasil Penilaian</h2>

                                <!-- Score Circle -->
                                <div class="{{ $attempt->score >= 70 ? 'bg-emerald-100 text-emerald-600 border-emerald-200' : 'bg-rose-100 text-rose-600 border-rose-200' }} mx-auto mb-6 flex h-28 w-28 items-center justify-center rounded-full border-4 shadow-lg">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <!-- Correct Answers -->
                                    <div class="rounded-lg bg-green-200 p-4 shadow-sm">
                                        <div class="mb-2 flex items-center justify-center">
                                            <svg class="h-6 w-6 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                            </svg>
                                        </div>
                                        <div class="text-2xl font-bold text-emerald-600">{{ $userAnswers->where('is_correct', true)->count() }}</div>
                                        <div class="text-sm text-gray-600">Benar</div>
                                    </div>

                                    <!-- Wrong Answers -->
                                    <div class="rounded-lg bg-rose-200 p-4 shadow-sm">
                                        <div class="mb-2 flex items-center justify-center">
                                        ...
                                        <div class="text-2xl font-bold text-rose-600">{{ $questions->count() - $userAnswers->where('is_correct', true)->count() }}</div>
                                ...
                                <div class="mt-4 rounded-lg bg-white p-3 shadow-sm">
                                    <div class="text-lg font-semibold text-gray-800">Total Soal: {{ $questions->count() }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
