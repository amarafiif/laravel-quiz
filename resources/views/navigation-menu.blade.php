    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        @guest
            ...
            <div class="space-y-1 pb-3 pt-2">
                <a href="{{ route('login') }}" class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-600 transition duration-150 ease-in-out hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800">
                    {{ __('Login') }}
                </a>
                <a href="{{ route('register') }}" class="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-600 transition duration-150 ease-in-out hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800">
                    {{ __('Register') }}
                </a>
            </div>
        @endguest
