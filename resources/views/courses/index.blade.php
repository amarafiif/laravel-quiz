                            ...
                            <div class="flex flex-col space-y-4 lg:flex-row lg:items-center lg:space-x-6 lg:space-y-0">
                                ...
                                <div class="flex flex-shrink-0 justify-center">
                                    <a href="{{ route('courses.show', $item->code) }}"
                                        class="inline-flex items-center rounded-md bg-sky-500 px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2">
                                        Lihat Kuis
                                    </a>
                                </div>
                            </div>
