...
@section('form-content')
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="mt-1">
                <x-input id="password" class="{{ $errors->has('password') ? 'border-red-500' : '' }} block w-full appearance-none rounded-lg border border-gray-300 px-3 py-3 text-sm placeholder-gray-400 focus:border-sky-500 focus:outline-none focus:ring-sky-500" type="password" name="password"
